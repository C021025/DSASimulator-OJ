...
type EditorProps = {
    ...
    coderHeight: string; // 编辑器高度
}

const monacoEditorOptions: MonacoEditorProps["options"] = {
...
export const Editor: React.FC<EditorProps> = ({ code, language, coderHeight, setCode, setLanguage }) => {
    return (
        <>
            {/* 选择语言 */}
            <div>
                <Select
                    size="small"
                    className="w-[100px] m-0 mt-2 ml-2"
                    value={language}
                    options={[
            ...
            {/* 代码区 */}
            <div className="flex-grow mb-[2px]">
                <MonacoEditor
